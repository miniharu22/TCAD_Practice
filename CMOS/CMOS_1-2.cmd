...
;; Doping & Mesh
(sdedr:define-constant-profile "ConstantProfileDefinition_substrate" "ArsenicActiveConcentration" Nsub)
...
(sdedr:define-gaussian-profile "AnalyticalProfileDefinition_SDprof" "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 1e20 "ValueAtDepth" Nsub "Depth" 0.080 "Gauss" "Factor" 0.4)
...
(sdedr:define-gaussian-profile "AnalyticalProfileDefinition_SDextprof" "BoronActiveConcentration" "PeakPos" 0 "PeakVal" 5e18 "ValueAtDepth" Nsub "Depth" 0.035 "Gauss" "Factor" 0.8)
