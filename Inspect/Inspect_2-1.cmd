...
(sdedr:define-refeval-window "Line_SourceExt" "Line" (position (* HalfLtot -2.0) 0.0 0.0) (position (+ (* HalfLg -1.0) gab) 0.0 0.0))
(sdedr:define-refeval-window "Line_DrainExt" "Line" (position (- HalfLg gab) 0.0 0.0) (position (* HalfLtot 2.0) 0.0 0.0))
